...
mod tests {
    ...
    fn test_keyword_from() {
        ...
        assert_eq!(Keywords::from("of").unwrap(), Keywords::Of);
        ...
        assert_eq!(Keywords::from("match").unwrap(), Keywords::Match);
    ...
    fn test_keyword_to_string() {
        ...
        assert_eq!(Keywords::Of.to_string(), "of");
        ...
        assert_eq!(Keywords::Match.to_string(), "match");
